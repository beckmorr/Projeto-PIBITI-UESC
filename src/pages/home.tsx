...
export const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center p-8 mt-10 animate-in fade-in duration-500 max-w-[1400px] mx-auto">
      <div className={`grid gap-8 transition-all duration-500 w-full ${isPanelOpen ? "grid-cols-1 lg:grid-cols-[400px_1fr]" : "grid-cols-1 max-w-md"}`}>
        ...
        {/* COLUNA DIREITA: FORMULÁRIO DE DADOS (APARECE INICIALMENTE) */}
        {isPanelOpen && (
          <div className="bg-white white:bg-slate-900 rounded-3xl border border-slate-200 white:border-slate-800 shadow-2xl flex flex-col h-fit max-h-[80vh] overflow-hidden animate-in slide-in-from-right duration-500">
